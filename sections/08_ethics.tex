...
non-consenting person is a harm, not a product; the pipeline described here does
nothing to enable that beyond what the underlying public endpoints already permit,
but deployments should verify subject consent as a precondition, and model
